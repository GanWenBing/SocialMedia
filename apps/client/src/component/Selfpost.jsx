...
const Selfpost = ({befetch, setBeFetch}) => {
  ...
  useEffect(() => {
    if(befetch){
    fetch(`api/getAllposts/${currentUser.user.iduser}`)
        ...
        <>
          ...
          <div className="flex items-center justify-between" key={post.idPosts}>
            <div className="flex items-center ">
              <div className="w-12 h-12">
                <img
                  src={
                    post.user.coverPic != null ? post.user.coverPic : profile
                  }
          ...
          <div className="flex justify-between mx-6">
            {!like.includes(post.idPosts) && modal == false ? (
              <div className="flex items-center">
                <AiOutlineLike
                  className="pl-2 w-8 h-8 text-[18px]"
                  onClick={() => {
                    likePost(post.idPosts);
                  }}
                />
              ...
              <div className="flex items-center" onClick={unlikePost}>
                <AiOutlineLike
                  className="pl-2 w-8 h-8 text-[18px] bg-blue-600"
                  onClick={() => {
                    unlikePost(post.idPosts);
                  }}
                />
